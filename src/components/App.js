...
class App extends Component{
  ...
  async loadBlockchainData() {
    ...
    if(tetherData) {
      ...
      console.log("balance from tether account:", tetherBalance)
    } else {
      ...
      if(rwdTokenData) {
        ...
        console.log("balance from reward token account:",rwdTokenBalance)
        ...
        window.alert("Reward Token contract not deployed to detect network")
          ...
          if(decentralBankData) {
            ...
            console.log("balance from staking account:", stakingBalance)
          } else {
  ...
  constructor(props) {
    ...
    render(){
        let content
        {this.state.loading ? content= <p id="loader" style={{margin : '30px'}} className="text-center">Loading Please......</p> : content = <Main
